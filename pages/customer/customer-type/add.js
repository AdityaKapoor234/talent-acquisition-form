...
export default function Add_Customer() {
  ...
  const OnSave = ()=>{
    ...
    CustomerApi.AddCustomer(10,data)
    .then((response) => {
      if (response.data.httpStatusCode === 200) {
        toast.success(response.data.message);
        Router.push(`/customer/customer-type/1/add`);
      }
    })
    .catch((error) => {
      toast.error(
        ...
        <DashboardLayoutComponent>
          <div className="row border-box">
            <div className="col-md-5">
              <div className="hamburger">
                <span>customer / customer Type / </span> Add customer
              </div>
            ...
            <div className="col-md-7 btn-save">
              ...
              <div
                className="Cancel-btn custom-btn"
                onClick={() => {
                  Router.push(`/customer/customer-type/type`);
                }}
              >
                <span>Cancel </span>
              </div>
          ...
          <div className="row">
            <div className="col-m-12">
              <AddCustomer handle={stateHandle.bind(this)}/>
            </div>
          </div>
        </DashboardLayoutComponent>
        <Dialog
