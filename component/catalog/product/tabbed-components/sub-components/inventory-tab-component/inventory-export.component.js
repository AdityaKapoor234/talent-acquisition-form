...
export default function InventoryImportComponent(props) {
    ...
    const [isViewObj, setIsViewObj] = useState({});
                                    ...
                                    return (
                                        <div className="col-md-12">
                                            <div className="tableCell">
                                                ...
                                                <div className="tableBody col ps-2 elip-text" title={val?.batch_number ? val?.batch_number : "-"}>
                                ...
                                <div className="col-md-4">
                                    ...
                                    {/* <div className="row">
                                        <div className="col-md-4"> */}
                                            <div className="login-form ">
                                                <label>
                                                    Manufacturing Date<span className="mandatory-star">*</span>
                                                </label>
                                                <input
                                                    type="text"
                                                    readonly="readonly"
                                                    value={convertDateStringToDateAPI(isViewObj?.manufacture_date)}
                                                />
                                            </div>
                                        {/* </div>
                                    </div> */}
                                        ...
                                        <div className="col-md-4"> */}
                                            <div className="login-form ">
                                                ...
                                                <input
                                                    type="text"
                                                    readonly="readonly"
                                                    value={convertDateStringToDateAPI(isViewObj?.expire_date)}
                                                />
                                            </div>
                                        {/* </div>
                                    </div> */}
                                    {/* <div className="row">
                                        <div className="col-md-4"> */}
                                            <div className="login-form ">
                                                <label>
                                                    Inventory Type<span className="mandatory-star">*</span>
                                                </label>
                                                <input
                                                    type="text"
                                                    readonly="readonly"
                                                    value={isViewObj?.inventory_type}
                                                />
                                            </div>
                                        {/* </div>
                                    </div> */}
