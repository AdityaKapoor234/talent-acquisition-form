...
import TypeList from "../../component/articles/type/type-list";
...
export default function ArticleType() {
  ...
  const handleKeyPress = (event) => {
    ...
    if (event.key === "Enter") {
      Router.push({
        pathname: "/article-type",
        query: router_query_object,
      });
      setCurrentPage(1)
      getTypeList(1, wordEntered);
    }
  };
  ...
  let onPageChange = function (e, page) {
    setCurrentPage(page)
    getTypeList(page, wordEntered)
  };

  const getTypeList = (page, search) => {
    setIsLoader(true);
    ArticleApi.typeList(page, search)
      .then((response) => {
        setType(response.data.data.list);
        setTotalType(response.data.data);
          ...
          <div className="row border-box">
            <div className="col-md-6">
              <div className="hamburger">
                <span>Article / </span>Type
              </div>
              <div className="page-name">Type</div>
            </div>
            ...
            <div className="col-md-2 btn-save">
              <div
                ...
                onClick={() => {
                  Router.push(`/article-type/create`);
                }}
              >
                <span>Add New </span>
              </div>
            ...
            <div className="col-md-12 ">
              {
                ...
                //   type && type.length === 0 ? <div className="not-found">No Data Found</div> :
                    <TypeList type={type} />
                )
              }
