...
import AdvertiseWithUsList from "../../component/inquiry/advertise-with-us/advertise-with-us-list";
...
export default function AdvertiseWithUs() {
	...
	const [totalAdvertiseWithUs, setTotalAdvertiseWithUs] = useState([]);
	...
	const handleKeyPress = (event) => {
		...
		if (event.key === "Enter") {
			...
			setCurrentPage(1)
			advertiseWithUsList(1, wordEntered);
		}
	};
	...
	const handleFilter = (event) => {
		...
		if (event.target.value === "") {
			...
			advertiseWithUsList(1, "");
		}
	};

	let onPageChange = function (e, page) {
		setCurrentPage(page)
		advertiseWithUsList(page, wordEntered)
	};

	const advertiseWithUsList = (page, search) => {
		setIsLoader(true);
		InquiryApi.advertiseWithUsList(page, search)
			.then((response) => {
				setAdvertiseWithUs(response.data.data.list);
				setTotalAdvertiseWithUs(response.data.data.total);
	...
	useEffect(() => {
		...
		advertiseWithUsList(currentPage, "");
	}, []);
					...
					<div className="row border-box">
						...
						{/* <div className="col-md-2 btn-save">
							<div
								...
								onClick={() => {
									Router.push(`/advertise-with-us/create`);
								}}
							>
								<span>Add New </span>
							</div>
						...
						<div className="col-md-12 ">
							{
								isLoader ? (
									...
									<AdvertiseWithUsList advertiseWithUs={advertiseWithUs} />
								)
							}
						...
						<div className="col-md-12 justify-content-between d-flex position-relative">
							<div className="pagiantion-category">
								...
								<div className="position-absolute totalCount" style={{ right: 23, bottom: 5 }}>
									Total Advertisements: {totalAdvertiseWithUs}
								</div>
							</div>
						</div>
					</div>
