...
export default class DietCreate extends Component {
	constructor(props) {
		...
		this.state = {
			...
			input: {
				name: props?.diet?.name ? props.diet?.name : "",
				description: props?.diet?.description ? props?.diet?.description : "",
				sort_order: props?.diet?.sort_order ? props.diet?.sort_order : "",
				icon_url: props?.diet?.icon_url ? props?.diet?.icon_url : "",
				banner_url: props?.diet?.banner_url ? props?.diet?.banner_url : "",
				banner_url_sm: props?.diet?.banner_url_sm ? props?.diet?.banner_url_sm : "",
				is_active: props?.diet?.is_active ? props?.diet?.is_active : false,
				show_in_main_menu: props?.diet?.show_in_main_menu ? props?.diet?.show_in_main_menu : false,
			},
		};
	}
	...
	static getDerivedStateFromProps(nextProps, prevState) {
		if (
			...
			return {
				...
				mode: nextProps?.mode,
				input: {
					name: nextProps?.diet?.name ? nextProps.diet?.name : "",
					description: nextProps?.diet?.description ? nextProps?.diet?.description : "",
					sort_order: nextProps?.diet?.sort_order ? nextProps.diet?.sort_order : "",
					icon_url: nextProps?.diet?.icon_url ? nextProps?.diet?.icon_url : "",
					banner_url: nextProps?.diet?.banner_url ? nextProps?.diet?.banner_url : "",
					banner_url_sm: nextProps?.diet?.banner_url_sm ? nextProps?.diet?.banner_url_sm : "",
					is_active: nextProps?.diet?.is_active ? nextProps?.diet?.is_active : false,
					show_in_main_menu: nextProps?.diet?.show_in_main_menu ? nextProps?.diet?.show_in_main_menu : false,
				},
			};
		}
		return null;
