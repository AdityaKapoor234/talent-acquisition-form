                            ...
                            <div className="row" key={index}>
                                <div className="col-md-12">
                                    <div className="tableCell">
                                        ...
                                        <div className="col-2 px-2 text-center elip-text" title={p?.price_after_coupon_discount}>₹&nbsp;{p?.price_after_coupon_discount?.toFixed(2).toString().replace(/\B(?=(?:(\d\d)+(\d)(?!\d))+(?!\d))/g, ',')}</div>
