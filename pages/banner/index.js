...
import BannerList from "../../component/cms/banner/banner-list";
...
export default function Banner() {
	...
	let onPageChange = function (e, page) {
		setCurrentPage(page)
		bannerList(page, wordEntered)
	};

	const bannerList = (page, search) => {
		setIsLoader(true);
		BannerApi.bannerList(page, search)
			.then((response) => {
				setBanner(response.data.data.list);
				setTotalBanner(response.data.data);
					...
					<div className="row border-box">
						<div className="col-md-10">
							<div className="hamburger">
								<span>CMS / </span>Banner
							</div>
							<div className="page-name">Banner</div>
						</div>
					...
					<div className="row sticky-scroll scroll">
						<div className="col-md-12 ">
						{
                                isLoader ? (
                                    ...
                                    // banner && banner.length === 0 ? <div className="not-found">No Data Found</div> :
						...
						<div className="col-md-12 justify-content-between d-flex position-relative">
							<div className="pagiantion-category">
								...
								<div className="position-absolute totalCount" style={{ right: 23, bottom: 5 }}>
									Total Banners: {totalBanner.total}
								</div>
							</div>
						</div>
					</div>
