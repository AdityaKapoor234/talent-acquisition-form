...
export const GET_CUSTOMER_GIFT_CARD_REDEEM = `${ORDER_SERVICE}/manage/gift/redeem/{{id}}?page={{page}}`;
export const GET_CUSTOMER_GIFT_CARD_SEND = `${ORDER_SERVICE}/manage/gift/send/{{id}}?page={{page}}`;
...
export const CUSTOMER_WALLET_TRANSACTION =`${USER_SERVICE}/manage/wallet/{{id}}/transation?page={{page}}`;
