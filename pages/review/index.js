...
import ReviewList from "../../component/catalog/review/review-list";
...
export default function Review() {
  ...
  let onPageChange = function (e, page) {
    setCurrentPage(page)
    reviewList(page, wordEntered)
  };

  const reviewList = (page, search) => {
    setIsLoader(true);
    ReviewApi.reviewList(page, search)
      .then((response) => {
        setReview(response.data.data);
        setTotalReview(response.data.data);
