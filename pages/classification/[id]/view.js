...
export default function ClassificationViewDetails() {
          ...
          <div className="row border-box">
            <div className="col-md-5">
              <div className="hamburger">
                <span>Catalog / Classification / </span>View Classification
              </div>
              <div className="page-name">Classification Details</div>
            </div>
