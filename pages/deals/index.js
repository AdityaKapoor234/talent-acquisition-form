...
import DealsList from "../../component/cms/deals/deals-list";
...
export default function Deals() {
  ...
  let onPageChange = function (e, page) {
    setCurrentPage(page)
    dealsList(page, wordEntered)
  };

  const dealsList = (page, search) => {
    setIsLoader(true);
    DealsApi.dealsList(page, search)
      .then((response) => {
        setDeals(response.data.data.list);
        setTotalDeals(response.data.data);
        ...
        <DashboardLayoutComponent>
          <div className="row border-box">
            <div className="col-md-6">
              ...
              <div className="page-name">Deals</div>
            </div>
            ...
            <div className="col-md-12 ">
              {
                isLoader ? (
                  ...
                  // deals && deals.length === 0 ? <div className="not-found">No Data Found</div> :
