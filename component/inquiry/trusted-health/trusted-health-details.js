...
export default class TrustedHealthDetails extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      sort_order: props?.trustedHealth?.sort_order
        ? props?.trustedHealth?.sort_order
        : "",
      content: props?.trustedHealth?.content
        ? props?.trustedHealth?.content
        : "",
      is_trust_health: props?.trustedHealth?.is_trust_health
        ? props?.trustedHealth?.is_trust_health
        : "",
      path: props?.trustedHealth?.image_url
        ? props?.trustedHealth?.image_url
        : "",
      read_more_url: props?.trustedHealth?.read_more_url
        ? props?.trustedHealth?.read_more_url
        : "",
      img_sm: "file-input-sm",
      img_lg: "file-input-lg",
      img_icon: "file-input-icon",
	  description: props?.trustedHealth?.description ? props?.trustedHealth?.description : "",
	  shortDescription: props?.trustedHealth?.short_description ? props?.trustedHealth?.short_description : "",
	  banner: props?.trustedHealth?.banner ? props?.trustedHealth?.banner : "",
	  smBanner: props?.trustedHealth?.sm_banner ? props?.trustedHealth?.sm_banner : "",
    };
  }
  static getDerivedStateFromProps(nextProps, prevState) {
    if (
      ...
      return {
		...
		description: nextProps?.trustedHealth?.description ? nextProps?.trustedHealth?.description : "",
	  	shortDescription: nextProps?.trustedHealth?.short_description ? nextProps?.trustedHealth?.short_description : "",
	  	banner: nextProps?.trustedHealth?.banner ? nextProps?.trustedHealth?.banner : "",
	  	smBanner: nextProps?.trustedHealth?.sm_banner ? nextProps?.trustedHealth?.sm_banner : "",
      };
    }
    return null;
  }
  ...
  bannerHandle = (name, url) => {
	this.setState({bannerHandle: url});
	this.props?.banner(url);
  }

  smBannerHandle = (name, url) => {
	this.setState({smBannerHandle: url});
	this.props?.smBanner(url);
  }
                    ...
                    <div className="col-md-4">
                      ...
                      <div className="login-form ">
                        ...
                        <textarea
                          ...
                          onChange={(event) => {
                            this.contentHandle(event);
                          }}
                        />
                      </div>
                      <div className="login-form ">
                        <label>
                          Sort Order<span className="mandatory-star">*</span>
                        </label>
                        <input
                          type="number"
                          min="0"
                ...
                <div className="col">
                  <div className="row mt-4">
                    <div className="col-md-4">
                      ...
                      <div>
                        <a href={this.state.read_more_url}>
                          <button className="custom-btn w-50">
                            Read More
