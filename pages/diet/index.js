...
import DietList from "../../component/catalog/diet/diet-list";
...
export default function Diet() {
  ...
  let onPageChange = function (e, page) {
    setCurrentPage(page)
    dietList(page, wordEntered)
  };

  const dietList = (page, search) => {
    setIsLoader(true);
    DietApi.dietList(page, search)
      .then((response) => {
        setDiet(response.data.data.list);
        setTotalDiet(response.data.data);
          ...
          <div className="row border-box">
            <div className="col-md-6">
              <div className="hamburger">
                <span>Catalog / </span>Diet
              </div>
              <div className="page-name">Diet</div>
            </div>
            ...
            <div className="col-md-12 ">
              {
                isLoader ? (
                  ...
                  // diet && diet.length === 0 ? <div className="not-found">No Data Found</div> :
                    <DietList diet={diet} />
                )
              }
