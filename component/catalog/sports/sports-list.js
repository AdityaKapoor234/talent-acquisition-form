    ...
    render() {
        return (
            <div data-component="CustomerComponent">
                ...
                {
                this.state.sports && this.state.sports.length === 0 ? <div className="not-found">No Data Found</div> :
                    this.state.sports?.map((p, index) => {
                    return (
