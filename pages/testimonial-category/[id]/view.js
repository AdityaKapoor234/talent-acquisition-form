...
export default class TestimonialCategoryViewDetails extends Component {
  constructor(props) {
    super(props);
    this.state = {
      id: props?.id,
            ...
            <div className="row border-box">
              <div className="col-md-5">
                <div className="hamburger">
                  <span>Testimonial / Category / </span>View Category
                </div>
                <div className="page-name">
                  View Category Details - {this.state.testimonialCategory?.name}
                </div>
              </div>
