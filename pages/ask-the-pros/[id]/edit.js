...
import Askthepros from "../../../component/ask-the-pros/ask-the-pros-details";
...
export default function AsktheprosEditDetails({id}) {
        ...
        <DashboardLayoutComponent>
          ...
          <div className="row">
            <div className="col-m-12">
              <Askthepros customer={customer} mode={mode} active={activeHandle} />
            </div>
          </div>
        </DashboardLayoutComponent>
      </main>
