...
import GoalsList from "../../component/catalog/goals/goals-list";
...
export default function Goals() {
  ...
  let onPageChange = function (e, page) {
    setCurrentPage(page)
    goalsList(page, wordEntered)
  };

  const goalsList = (page, search) => {
    setIsLoader(true);
    GoalsApi.goalsList(page, search)
      .then((response) => {
        setGoals(response.data.data.list);
        setTotalGoals(response.data.data);
          ...
          <div className="row border-box">
            <div className="col-md-6">
              <div className="hamburger">
                <span>Catalog / </span>Goals
              </div>
              <div className="page-name">Goals</div>
            </div>
            ...
            <div className="col-md-12 ">
              {
                isLoader ? (
                  ...
                  // goals && goals.length === 0 ? <div className="not-found">No Data Found</div> :
