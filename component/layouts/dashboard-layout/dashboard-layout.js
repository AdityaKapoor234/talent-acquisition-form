...
export default function DashboardLayoutComponent({ children }) {
    ...
    const [tabCustomer, setTabCustomer] = useState(pathArr === "customer" || pathArr === "customer-support-information" || pathArr === "customer-type" ? true : false);
                            ...
                            <div className='menu'>
                                ...
                                {tabCustomer &&
                                    <ul>
                                        ...
                                        <li className={categary=== "customer-type" ? "sub_active":""} onClick={()=> handleCategary("/customer/customer-type/type","customer-type")}>customer type</li>
